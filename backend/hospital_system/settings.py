...
# 地理围栏配置
HOSPITAL_LATITUDE = float(os.getenv('HOSPITAL_LATITUDE', '39.9042'))
HOSPITAL_LONGITUDE = float(os.getenv('HOSPITAL_LONGITUDE', '116.4074'))
GEOFENCE_RADIUS = int(os.getenv('GEOFENCE_RADIUS', '200'))  # 单位：米
